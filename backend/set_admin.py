#!/usr/bin/env python3
"""
Set or update the admin login credentials for Alan Rich LLC.

Usage:
    python backend/set_admin.py <email> <password>

Examples:
    python backend/set_admin.py admin@alanrichllc.org mypassword123
    python backend/set_admin.py newemail@alanrichllc.org newpassword
"""
...
def main():
    if len(sys.argv) != 3:
        ...
        print("Example: python set_admin.py admin@alanrichllc.org mypassword123")
        sys.exit(1)
